...
\lstdefinestyle{LaTeX}{language=[LaTeX]TeX, basicstyle=\small\ttfamily,
...
die folgenden Konventionen getroffen (grüne Spalte).  Hauptsächlich
betreffen diese die reformierte Rechtschreibung:
\begin{enumerate}

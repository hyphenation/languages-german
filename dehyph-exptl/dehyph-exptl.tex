...
\title{\texttt{dehyph-exptl}\thanks{This document describes the
    \texttt{dehyph-exptl} package v0.21.}}
...
mit \LaTeX\ und dem Paket \texttt{babel} zur Verfügung.
Zur\marginpar{\textbf{Achtung!}} Zeit ist dieses Paket nicht kompatibel
mit den Formaten Lua\LaTeX, Xe\LaTeX\ und p\LaTeX%
\footnote{Eine in Japan populäre \TeX-Variante.}%
%
.  Es sollte daher nur mit \LaTeX\ oder pdf\LaTeX\ verwendet werden.
Die experimentellen Trennmuster können dennoch mit Lua\LaTeX\ und
Xe\LaTeX\ verwendet werden, da \texttt{babel} in Verbindung mit Lua\TeX\
und Xe\TeX\ für die Sprachbezeichner \texttt{german}
bzw. \texttt{ngerman} bereits standardmäßig die experimentellen
Trennmuster lädt -- bereitgestellt durch das Paket \texttt{hyph-utf8}.
Nutzer von p\TeX\ können die experimentellen Trennmuster nicht verwenden
und müssen auf die durch \texttt{hyph-utf8} bereitgestellten
herkömmlichen Muster zurückgreifen.

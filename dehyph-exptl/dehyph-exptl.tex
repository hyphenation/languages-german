...
Anhang~\ref{sec:fragen} oder der diesem Paket beiliegenden
...
\item Die einfachste ist, die experimentellen Trennmuster ausgiebig zu
  testen und Fehler zu melden (siehe
  Abschnitt~\ref{sec:fehltrennungen}).
...
\item[Betreff] Der Betreff einer Fehlermeldung sollte aussagekräftig
  ...
  Abschnitt~\ref{sec:fehltrennungen} dem Betreff der E-Mail in eckigen

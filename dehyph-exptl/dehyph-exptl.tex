...
\item\label{enum:tradSinn} Sinnentstellende und irreführende Trennungen
  werden möglichst vermieden \cite[K~?]{duden:1991}:\par\nobreak% [K~70]
...
\item\label{enum:tradOW} In Ableitungen von Namen auf \emph{-ow} wird
  ...
  \emph{-ers} unterdrückt \cite[K~?]{duden:1991}:\par\nobreak% [K~91]
...
\item\label{enum:reformClusterLR} In Fremdwörtern bleiben die
  Verbindungen aus Buchstaben für einen Konsonanten + \emph{l} und
  \emph{r} ungetrennt, sofern keine Wortfuge vorliegt.  Dies schließt
  \emph{phl}, \emph{phr}, \emph{thr} ein; nicht jedoch \emph{str}
  \cite[\S~112]{amtlRegeln:2006, amtlRegeln:2006:duden}
  i.\,V.\,m.~\cite[K~?]{duden:1991}:\par\nobreak% [K~86]
...
\item\label{enum:reformClusterGN} In Fremdwörtern bleibt die
  Konsonantenverbindung \emph{gn} ungetrennt
  \cite[\S~112]{amtlRegeln:2006, amtlRegeln:2006:duden}
  i.\,V.\,m.~\cite[K~?]{duden:1991}:\par\nobreak% [K~87]

  \begin{tabular}[t]{>{\color{reformcol}}l>{\color{unerwcol}}l}
    Co-gnac & Cog-nac\\
    igno-rie-ren & ig-no-rie-ren\\
  \end{tabular}
  \quad\textit{aber:}\quad
  \begin{tabular}[t]{>{\color{reformcol}}l>{\color{unerwcol}}l}
    Zeug-nis\\

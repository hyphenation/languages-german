...
\item Die herkömmlichen Trennmuster für die traditionelle deutsche
  Rechtschreibung lassen sich nicht reproduzieren, da die
  zugrundeliegende Wortliste verschollen ist.  Umfang und Qualität der
  ursprünglichen Wortliste sind nicht mehr bekannt und die Pflege der
  Trennmuster ist schwierig bis unmöglich.  Für freie Software ist dies
  kein zufriedenstellender Zustand.

\item Für die Trennmuster in traditioneller Rechtschreibung existiert
  inzwischen eine Ausnahmeliste%
...
%
  Die herkömmlichen Trennmustern berücksichtigen dies nicht und trennen
  häufig \mbox{\emph{S-S}}: \textls{">GR\ftr{ÖS-S}E"<},
...
\bigskip
\noindent\textit{beide Rechtschreibungen}
...
\item Die Trennmusterdateien enthalten eine Mischung aus \Abk{t1}- sowie
  ...
  16-Bit-fähigen \TeX-Varianten werden saubere Trennmuster nötig.
\end{itemize}

...
\end{lstlisting}
Das letzt Kommando sollte nun den Wert \verb+64m+ zurückliefern.

\Programm{Git} enthält in der Version 1.5.6.4 einen Patch, der ein
Problem mit dieser Konfigurationsvariablen behebt und den
Netzwerkzugriff auf dieses Repositorium verbessert.  Mit älteren
\Programm{Git}-Versionen können auch höhere Werte für

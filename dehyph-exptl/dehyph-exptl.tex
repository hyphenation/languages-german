...
\begin{abstract}
  ...
  varities of Standard German.  The patterns can be used with packages
...
%
  Die herkömmlichen Trennmuster berücksichtigen dies nicht und trennen
  häufig \mbox{\emph{S-S}}: \textls{">GR\ftr{ÖS-S}E"<},
  \textls{">GR\ftr{ÜS-S}E"<}, \textls{">M\ftr{AS-S}ES"<}.%
  \footnote{Das Paket \texttt{Babel} versucht diese Schwäche mit Hilfe

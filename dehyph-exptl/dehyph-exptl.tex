...
Das Projekt \emph{Freie Wortlisten und Trennmuster für die deutsche
  Sprache} hat sich deshalb das Ziel gesetzt, neue Trennmuster hoher
Qualität für die Benutzung in \TeX\ und \Programm{OpenOffice} zu
erstellen.
...
\item Schweizer Standarddeutsch%
  ...
  \footnote{Für Texte in Schweizer Standarddeutsch fehlt zur Zeit die
    ...
    \lstinline[style=LaTeX]+\"ss+ benötigt (Dreikonsonantenregel).
    Siehe auch Abschnitt~3 in der Projektbeschreibung.}%
  .
\end{itemize}
...
\item Konsonantenänderungen, die bei der Trennung nach traditioneller
  ...
  zufriedenstellend handhaben.%
  %
  \footnote{Vgl. Abschnitt~3 in der Projektbeschreibung.}
...
\begin{frageantwort}{Können Trennungen mit einer Silbenlänge von nur
  ...
  Wird die Silbenmindestlänge für die Worttrennung auf eins verringert,
  können falsche Trennungen auftreten.  Zum Beispiel könnte in einem
  Wort \lstinline[style=LaTeX]+zyxwv+ das Muster
  \lstinline[style=Text]+1yx+ zu der unerlaubten Trennung ">z-yxwv"<
  führen.
\end{frageantwort}

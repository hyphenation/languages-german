...
\frage{faBugsKrit}{Was ist noch beim Einreichen von Trennfehlern zu
  beachten?}
\end{enumerate}
...
\footnote{\url{http://groups.google.de/group/trennmuster-opensource?hl=de}}
%
Die Mailingliste kann nach Anmeldung%
...
ersatzweise in der Newsgruppe \Datei{de.comp.text.tex} besprochen
werden.}
%
für Fragen und Hinweise genutzt werden.}
...
\item Besonders hilfreich wäre Mitarbeit am Projekt.  Obwohl schon
  ...
  Mailingliste zu schicken.  Als Einstieg kann auch die Aufgabenliste in
  der Projektbeschreibung dienen.

\item Nach Fertigstellung der Prüfmaske kann mittelfristig auch durch
  systematische Durchsicht eines Teils der Wortliste geholfen werden.
\end{itemize}
}
...
\antwort{faBugsSammeln}{Ganz egal.  Bei mehreren Fehlern kann es jedoch
sinnvoll sein, diese thematisch zu gruppieren.}


\antwort{faBugsKrit}{In Abschnitt~\ref{sec:fehltrennungen} wurden drei
alternative Kriterien angegeben, für Fehler, die sehr wahrscheinlich in
den Trennmustern korrigiert werden (können).  Zur einfacheren Zuordnung
können Sie bei einzelnen Fehlern dem Betreff Ihrer E-Mail das
entsprechende Kriterium in eckigen Klammern voranstellen, zum Beispiel:

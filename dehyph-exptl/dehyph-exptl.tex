...
\newcounter{frage}% Zaehler fuer Fragen mit Formatierung.
\renewcommand*{\thefrage}{\arabic{frage}.}
\newboolean{nextfrage}

\makeatletter

%%% Neue zref-Liste frage = (text, anchor).
\zref@newlist{frage}
\zref@newprop{text}{??}
...
\newenvironment{frageantwort}[1]{%
  \par\vspace{.75\baselineskip plus .1\baselineskip minus .1\baselineskip}

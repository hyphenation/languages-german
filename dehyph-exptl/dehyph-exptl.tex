...
\item\label{enum:tradEszett} Wird der Buchstabe~\emph{ß} durch
  ...
  keine eindeutige Trennung möglich wird, zum Beispiel an Wortfugen, so
  werden die betroffenen Trennungen gemäß \regelref{enum:tradDoppeld}
  unterdrückt.  In der Folge wird gegebenenfalls auch die Trennung von
  \emph{ss/SS} unterdrückt.

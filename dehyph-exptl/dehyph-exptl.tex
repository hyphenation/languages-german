...
Trennmuster für die Benutzung in \TeX\ und OpenOffice zu erstellen.
...
\frage{faBugsSammeln}{Sollten Trennfehler einzeln oder gesammelt
  eingereicht werden?}
...
\antwort{faBugsSammeln}{Das ist egal.  Es sollten allerdings die
...
\item[Listenformat] Es erleichtert die Korrektur, wenn
  Berichtigungsvorschläge in Form einer Liste eingericht werden, die
  ...
  \item Die erste Spalte enthält das Wort in ungetrennter Form.
  \item Die zweite Spalte enthält das betreffende Wort in der
    Trennvariante nach traditioneller Rechtschreibung.
  \item Falls die Trennung nach reformierter Rechtschreibung davon
    abweicht, steht diese in der dritten Spalte.
  \item Die folgenden Spalten \emph{können} weitere Trennvarianten
    enthalten, etwa die falsche Trennung.  Eine kurze Erklärung sollte

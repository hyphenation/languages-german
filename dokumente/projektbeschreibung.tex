...
\item Die Trennmuster für die (traditionelle) (deutsch)schweizerische
  Rechtschreibung benötigen eine Sprachanbindung für \texttt{Babel} und
  \texttt{Polyglossia}.
...
\item Für einzelne Dokumente ist es wünschenswert, fachspezifische
  ...
  Trennmuster sind somit immer im Format vorhanden.  Es wäre daher
  sinnvoll, Trennmuster auch dynamisch während der Ausführung laden zu
...
\item Im Satz mit gebrochenen Schriften sollen langes und rundes~s ohne
  Auszeichnung im Quelltext richtig behandelt werden.  Vorstellbar sind
  eigene Muster zur Erkennung von Rund-s (und falschen Ligaturen -- oder
  besser den richtigen?) und ein Durchsuchen mehrerer entsprechender
  Tries während des Absatzumbruchs.  $\Rightarrow$ Vorschlag für
  Lua\TeX-Entwickler ausarbeiten

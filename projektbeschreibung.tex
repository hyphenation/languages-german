...
\item In Dokumenten muss trotz weiterentwickelter Trennmuster
  ...
  benötigt \TeX{}s Sprachenschnittstelle (Pakete \Programm{Babel} bzw.
  \Programm{Polyglossia}) einen Versionsmechanismus für die
  Trennmusteraktivierung.  $\Rightarrow$ Paket \Programm{hyphsubst}

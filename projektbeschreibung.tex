...
Die Kommunikation läuft derzeit über die Gruppe \Programm{Trennmuster-Opensource} bei Google%
...
\begin{tabularx}{\linewidth}[t]{lL}
  ...
  \verb+git clone http://repo.or.cz/r/wortliste.git+\\
  Stand & 2.\,1.\,2008\\
...
\item  Unterscheidung von Haupt- und Nebentrennstellen im von \TeX\ verwendeten Trennalgorithmus 
\end{itemize}



\section{Bisherige Ergebnisse}
\subsection{Wortlisten} Die von Werner Lemberg erstellte und kontrollierte Liste mit etwa 380.000 Wortformen steht in einem öffentlich zugänglichen \Programm{git}-Repositorium.%
\footnote{\url{http://repo.or.cz/}\qquad Eine \Programm{Git}-Version für Windows ist unter \url{http://code.google.com/p/msysgit/downloads/list} erhältlich, Datei \Datei{Git-1.5.4-rc3-preview20080113.exe} (Stand: 16.\,1.\,2007).}
Eine Kopie kann mit
\begin{verbatim}
...
\end{verbatim}
bezogen werden.%
\footnote{Neben dem Protokoll unterscheiden sich auch die
  Adressen!}
Im Repositorium sind auch einige Skripten zur Bearbeitung der
Wortliste enthalten.  Aktualisiert wird die Wortliste
(das gesamte lokale Repositorium) mit
\begin{verbatim}
git pull
\end{verbatim}
...
Die bisherigen Trennmusterdateien für die traditionelle und neue Rechtschreibung, die Dateien \Datei{dehypht.tex} und \Datei{dehyphn.tex}, können am \Abk{CTAN}%
...
Im Dateibereich der Google-Gruppe \Programm{Trennmuster-Opensource} sind Trennmuster verfügbar, die aus Werner Lembergs Liste generiert wurden.%
\footnote{\url{http://groups.google.de/group/trennmuster-opensource?hl=de}}

...
\end{verbatim}
bezogen werden.%
\footnote{Eine \Programm{Git}-Version für Windows ist unter \url{http://code.google.com/p/msysgit/downloads/list} erhältlich, Datei \Datei{Git-1.5.4-rc2-preview20071228.exe} (Stand: 4.\,1.\,2007).}
Aktualisiert wird das lokale Repositorium mit
\begin{verbatim}
git pull
\end{verbatim}
